            ...
            <form  name="frmUser" method="post" action="">
              <div  class="form_2">
                <div id="second-container" class="pagination">
                    ...
                    <?php
                       $result = mysql_query("SELECT fr_subject.*,sem.*,sy.* FROM fr_subject , fr_semester as sem , fr_sy as  sy WHERE sem.SYID = sy.SYID AND fr_subject.SemID = sem.SemID AND NOT EXISTS (SELECT * FROM fr_ins_subject WHERE fr_subject.SubCode =  fr_ins_subject.Subject AND fr_ins_subject.uid = '".$_POST['inst']."') AND status ='NOT ASSIGNED'");
