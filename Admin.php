								...
								<div class="row"  id="back">
									<div class="twelve columns">
										<?php
											...
											{
												require('termmanagement/semester.php');
											}
											else if(isset($_GET['SY']) && $_GET['SY'] == "SY")
											{
												require('termmanagement/schoolyear.php');
											}
											?>
									</div>
								</div>
...
require('termmanagement/AddSem.php');
require('termmanagement/addsy.php');
require('Subject Management/AddSubject.php');
?>
